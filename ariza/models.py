...
class Order(models.Model):
    ...
    ttj_nomer = models.CharField(max_length=100, blank=True)
    ttj_manzil = models.CharField(max_length=300, blank=True)
    viloyat = models.CharField(max_length=100, blank=True)
    tuman = models.CharField(max_length=100, blank=True)
    kocha = models.CharField(max_length=100, blank=True)
    telefon = models.CharField(max_length=100, blank=True)
    imtiyoz_nomi = models.CharField(max_length=100, blank=True)
    qavat = models.CharField(max_length=100, blank=True)    
